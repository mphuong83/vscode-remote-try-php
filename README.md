...
1. **Running a server:**
   ...
   - Edit the text on line 21 in `example.php ` and refresh the page to see the changes immediately take effect.
...
1. **Attach debugger to the server:**
   ...
   - Add a breakpoint to `example.php` if you haven't already.
